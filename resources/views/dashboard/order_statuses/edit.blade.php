<div class="modal fade animated rotateInDownLeft custo-rotateInDownLeft" id="editOrderStatusModel" tabindex="-1"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post" class="form-horizontal"
                      enctype="multipart/form-data" id="edit_order_status_form" data-parsley-validate="">
                    @csrf
                    {!! method_field('PUT') !!}
                    <div class="box-body">
