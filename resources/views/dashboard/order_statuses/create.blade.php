<div class="modal fade animated rotateInDownLeft custo-rotateInDownLeft" id="createOrderStatusModel" tabindex="-1"
     role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">إنشاء حالة طلب</h5>
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.order_statuses.store')}}" method="post" class="form-horizontal"
