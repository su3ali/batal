                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group type-col col-md-12">
                            ...
                            <select id="inputState" class="select2 type form-control" name="type">
                                ...
                                <option value="{{ \App\Enums\Core\ReasonType::customer()->value }}">
                                    {{ \App\Enums\Core\ReasonType::customer()->value }}</option>
                                <option value="{{ \App\Enums\Core\ReasonType::technician()->value }}">
                                    {{ \App\Enums\Core\ReasonType::technician()->value }}</option>
