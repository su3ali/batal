            ...
            <div class="card-header" id="bookingHeader">
                <section class="mb-0 mt-0">
                    <div role="menu" class="collapsed" data-toggle="collapse"
                        data-target="#defaultAccordion{{ $i }}" aria-expanded="true"
                        aria-controls="defaultAccordion{{ $i }}">
                        الحجز {{ $i + 1 }}
                    </div>
                </section>
            </div>

            <div id="defaultAccordion{{ $i }}" class="collapse @if ($i == 0) show @endif"
                aria-labelledby="..." data-parent="#toggleAccordion">
                <div class="card-body">
                        ...
                        <div class="row ">
                            <div class="col-xl-6 col-lg-6 col-sm-6  layout-spacing">
                                <section class="calender-custom">
                                    ...
                                    <input type="text" class="reservatoinData" data-itr="{{ $i }}"
                                        required id="getData" name="day[{{ $i }}]" hidden>
                                </section>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-sm-6  layout-spacing">
                                <section>
                                    ...
                                    <div class="d-flex gap-5 select-time-list flex-wrap"
                                        id="select-time-available_{{ $i }}">
                                        <div class="text-center">
                                            <a href="{{ asset('images/time.png') }}" target="_blank">
