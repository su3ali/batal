        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                ...
                <div id="frame">
                    <div id="sidepanel">
                        <div id="profile">
                            <p> {{ \App\Models\Setting::query()->first() ? \App\Models\Setting::query()->first()->name : 'site name' }}
                            </p>
                        </div>
                        <div id="search">
                                    ...
                                    @if (class_basename(get_class($room->sender)) == 'User')
                                        ...
                                        <li class="contact" data-thread-id="{{ $room->id }}">
                                            <div class="wrap">
                                                ...
                                                @else
                                                    <a href="{{ asset('images/user.jpg') }}" target="_blank">
                                    ...
                                    @else
                                        ...
                                        <li class="contact" data-thread-id="{{ $room->id }}">
                                            <div class="wrap">
                                                <span class="contact-status online"></span>
                                                @if ($tech->image)
                                                    <a href="{{ asset($tech->image) }}" target="_blank">
                                                        <img src="{{ asset($tech->image) }}" alt="" />
                                                    </a>
                                                @else
                                                    <a href="{{ asset('images/techn.png') }}" target="_blank">
                    ...
                    <div class="content">
                        <div class="contact-profile">
                            @if (class_basename(get_class($rooms->first()->sender)) == 'User')
                                ...
                                @endif
                                <p style="margin-top: 15px;" class="name-choose">
                                    ...
                                    @foreach ($rooms->first()->messages as $message)
                                        ...
                                        @else
                                            <li class="message replies received">
                                                <a href="{{ asset('images/tech.png') }}" target="_blank">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.sender.model_name == 'User') {
                            $('.name-choose').html(response.sender.first_name + ' ' + response
                                .sender.last_name);
                        ...
                        $.each(response.messages, function(index, message) {
                            var messageClass = message.sent_by_admin ? 'sent' :
                                'received replies';
                            ...
                            var messageContent = '<li class="message ' + messageClass +
                                '"><img src="' + img + '" alt=""/> <p>' + message
                                .message + '</p></li>';
                    ...
                    success: function(response) {
                        ...
                        if (response.users.length > 0) {
                            ...
                            $.each(response.users, function(index, user) {
                                ...
                                var messageContent =
                                    `<li class="contact" data-thread-id="` + user[
                                        'id'] + `">
                                            <div class="wrap">
                                                <span class="contact-status online"></span>
                        ...
                        if (response.technicians.length > 0) {
                            ...
                            $.each(response.technicians, function(index, technician) {
                                ...
                                var messageContent =
                                    `<li class="contact" data-thread-id="` + technician[
                                        'id'] + `">
                                            <div class="wrap">
                                                <span class="contact-status online"></span>
                                                <a href="` + url + `` + img + `" target="_blank">
