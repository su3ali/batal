                ...
                <form action="" method="post" class="form-horizontal"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-row mb-2">
                            ...
                            <div class="form-group start_from col-md-4" >

                                <label for="inputEmail4">{{__('dash.start_from')}}</label>
                                <input type="text" name="start_from" class="form-control start_from"
                                       id="inputEmail4"
                        ...
                        <div class="form-row mb-2">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="ter_cond_ar" id="ter_cond_ar" class="ckeditor" cols="10" rows="5"></textarea>
                                @error('ter_cond_ar')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="ter_cond_en" id="ter_cond_en" class="ckeditor" cols="10" rows="5"></textarea>
                                @error('ter_cond_en')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
