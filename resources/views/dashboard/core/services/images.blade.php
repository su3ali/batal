    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('dash.Service images')}}</h5>
            ...
            <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12">
                            <form method="post" action="{{ route('dashboard.core.service.uploadImage') }}"
    ...
    <script>
        ...
        $(function() {
            ...
            var dropzone = new Dropzone('#demo-upload', {
                url: "{{ route('dashboard.core.service.uploadImage') }}",
                maxFilesize: 1,
                paramName: 'file',
                addRemoveLinks: true,
                ...
                removedfile: function (file) {
                    $.ajax({
                        type: 'POST',
                        dataType: 'json',
                        url: '{{route('dashboard.core.service.deleteImage')}}',
