<div class="modal fade animated rotateInDownLeft custo-rotateInDownLeft" id="editGroupTechModel" tabindex="-1"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-row mb-3">
                            <div class="form-group col-md-12">
                                ...
                                <select required id="edit_technician_id" class="select2 form-control pt-1"
                                        name="technician_id">
