                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 py-2">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">تعديل التقاول والعقود</li>
                            </ol>
                        </nav>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6" style="min-height: 400px;">
                    <div class="col-md-12 text-left mb-3">
                        <h3>تعديل تقاول وعقود</h3>
                    </div>
                    <div class="col-md-12">
                        <form action="{{route('dashboard.core.contact.update', $contact->id)}}" method="post"
                            ...
                            <div class="box-body">
                                <div class="form-row mb-3">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title_ar" class="form-control"
                                               id="inputEmail4" value="{{$contact->title_ar}}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title_en" class="form-control"
                                               id="inputEmail4" value="{{$contact->title_en}}"
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea name="desc_ar" class="ckeditor" cols="30" rows="10">{{$contact->desc_ar}}</textarea>
                                        @error('desc_ar')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea name="desc_en" class="ckeditor" cols="30" rows="10">{{$contact->desc_en}}</textarea>
                                        @error('desc_en')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select id="inputState" class="select2 form-control pt-1"
                                            ...
                                            @foreach($categories as $key => $category)
                                                <option value="{{$key}}" @if($key == $contact->category_id) selected @endif>{{$category}}</option>
                                            @endforeach
                                        </select>
                                        @error('category_id')
                                        <div class="alert alert-danger">{{ $message }}</div>
